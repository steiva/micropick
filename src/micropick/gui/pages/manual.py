...
page only decides what a click and a key press mean.
...
__all__ = ["ManualPage", "KEY_TO_QT", "UNBOUND"]
...
class ManualPage(QWidget):
    ...
    def _install_shortcuts(self) -> None:
        ...
        WidgetWithChildrenShortcut: these fire while this page has focus and
        nowhere else. A global hotkey would drive the robot from whatever
        ...
        for key in LAYOUT:
            ...
            for code in KEY_TO_QT[key.name]:
                shortcut = QShortcut(QKeySequence(code), self)
                shortcut.setContext(
